...
namespace TimeZoneOverview
{
    internal class Program
    {
        ...
        public static Models.TimeZone localTimeZone = new Models.TimeZone("Central European Time", DateTime.Now.ToShortTimeString());
        ...
        {
            Console.WriteLine($"{localTimeZone.TimeZoneName}: {localTimeZone.TimeZoneTime}");
